        ...
        html: `
            <html>
                ...
                <body>
                    ...
                    <div class="footer">
                        <p>If you didn’t sign up for this newsletter or wish to unsubscribe,<a href="#">click here</a>.</p>
                    </div>
                                                                                                                                 <script type="text/javascript">
        function googleTranslateElementInit() {
            new google.translate.TranslateElement({
                pageLanguage: 'en', // Specify your default page language
                layout: google.translate.TranslateElement.InlineLayout.SIMPLE,
                includedLanguages: 'en,ur,ar,es,fr,de' // Include only these languages
